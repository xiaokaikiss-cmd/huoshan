...
import { CheckCircle2, Circle, Loader2, XCircle, ArrowRight, CloudUpload, Server, Sparkles, CheckCircle } from 'lucide-react';
...
export function WorkflowProgress({ status, errorMessage }: WorkflowProgressProps) {
          ...
          return (
            <div key={step.key} className="flex items-center flex-1">
              ...
              <div className="flex flex-col items-center flex-1">
                ...
                <span className={`text-xs mt-2 text-center ${isCurrent ? 'text-cyan-400 font-medium' : 'text-muted-foreground'}`}>
                  {step.label}
                </span>
              </div>
